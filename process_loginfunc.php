...
$cpf = $_POST['funcionario-cpf']; // Alterado de funcionario-username para funcionario-cpf
$senha = $_POST['funcionario-senha']; // Alterado de funcionario-password para funcionario-senha
